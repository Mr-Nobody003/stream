    ...
    try {
      if (isBroadcasting) {
        ...
        if (mode === 'screen' || mode === 'both') {
          ...
          // Adjusted for 120fps streaming while keeping bitrates stable
          const captureRes = resolution === '144' ? { width: 256, height: 144, frameRate: 120 }
                    : resolution === '240' ? { width: 426, height: 240, frameRate: 120 }
          ...
          const encoding = resolution === '144' ? { maxBitrate: 300_000, maxFramerate: 120 }
                         : resolution === '240' ? { maxBitrate: 600_000, maxFramerate: 120 }
                         : resolution === '360' ? { maxBitrate: 1_200_000, maxFramerate: 120 }
                         : resolution === '480' ? { maxBitrate: 2_500_000, maxFramerate: 120 }
                         : resolution === '720' ? { maxBitrate: 5_000_000, maxFramerate: 120 }
                         : resolution === '1440' ? { maxBitrate: 12_000_000, maxFramerate: 120 }
                         : resolution === '1080' ? { maxBitrate: 6_000_000, maxFramerate: 120 }
                         : undefined;
